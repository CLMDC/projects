...
//create array of data to be postedsubmit22
$post_data['oid'] = $oid;
  ...
  #tc a{
    ...
    display: contents !important;
                            ...
                            <div class="col-md-12">
                                ...
                                <input style="color: #fff; font-family: avenir-regular; font-weight: 500;  font-size: 20px;" type="submit" name="submit22" class="btn btn-success btn-send" value="Next" onclick="passVarToAffiliates();">  
