    ...
    <div class="formStyle">
      ...
      <form method="POST" oninput="txtFullDate.value = txtYear.value +'-'+ txtMonth.value +'-'+ txtDay.value"  _lpchecked="1">
        <!-- <input id="redirect_url" type="hidden" name="redirect_url" value="https://www.clmforex.com/demo-account-thank-you"; /> -->
                            ...
                            <input id="lead_source" type="hidden" name="lead_source" class="form-control" placeholder="Please enter your phone number *" required="required" data-error="Phone is required." value="Live Account (Bruno Ferreira)">
