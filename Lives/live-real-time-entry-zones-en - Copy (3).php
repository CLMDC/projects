  ...
  font-size: 14px;
                          ...
                          <div class="col-md-7" style="padding-right: 5px;">
                                <div class="form-group">
                                    ...
                                    <input class="wt" id="" type="tel" class="form-control" name="txtYear" pattern="[0-9]{4}" title="Enter the year as (YYYY)" placeholder="Year" required="required" data-error="Valid birthday is required.">

                                    <input class="wt" id="" type="tel" class="form-control" name="txtMonth" pattern="[0-9]{2}" title="Enter the month as (MM)" placeholder="Month" required="required" data-error="Valid birthday is required.">
  ...
  #tc a{
    ...
    display: contents !important;
                            ...
                            <div class="col-md-12">
                                ...
                                <!-- <input style="color: #fff; font-family: avenir-regular; font-weight: 500;  font-size: 20px;" type="submit" name="submit2" class="btn btn-success btn-send" value="Next" onclick="passVarToAffiliates();">
 -->


                                <button style="color: #fff; font-family: avenir-regular; font-weight: 500;  font-size: 20px;" type="submit"id="submit2" name="submit2" class="btn btn-success btn-send" onclick="passVarToAffiliates();">Next</button>
