  ...
  #tc a{
    ...
    display: contents !important;
                            ...
                            <div class="col-md-12">
                                ...
                                <input style="color: #fff; font-family: avenir-regular; font-weight: 500;  font-size: 20px;" type="submit" id="submit2" name="submit2" class="btn btn-success btn-send" value="Next">  
