    ...
    <div class="ht">
        ...
        <form method="POST" oninput="txtFullDate.value = txtYear.value +'-'+ txtMonth.value +'-'+ txtDay.value" _lpchecked="1" id="myform">
            ...
            <div class="col-md-5" style="padding-right: 5px; padding-left: 10px;">
                <div class="form-group">
                    <input onkeyup="javascript:capitalize(this);" id="individual-first-name" type="text" name="individual-first-name" class="form-control" placeholder="Nombre*" required="required" data-error="Firstname is required.">
            ...
            <div class="col-md-5" style="padding-left: 5px;">
                <div class="form-group">
                    <input onkeyup="javascript:capitalize(this);" id="individual-last-name" type="text" name="individual-last-name" class="form-control" placeholder="Apellido*" required="required" data-error="Lastname is required.">
                    <div class="help-block with-errors"></div>
                </div>
            </div>

            <!-- Hidden -->
            <input id="Preferred_Language__c" type="hidden" name="Preferred_Language__c" class="form-control" placeholder="Please enter your phone number *" required="required" data-error="Phone is required." value="Spanish">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <input oninput="this.value=this.value.toLowerCase()" id="UserName" type="email" name="UserName" class="form-control" placeholder="Correo electrónico*" required="required" data-error="Valid email is required." value="<?php if ( isset( $email ) )
						echo $emailError ?>">
            ...
            <div class="col-md-7" style="padding-right: 5px;">
                <div class="form-group">
                    ...
                    <input class="wt" id="txtYear" type="tel" class="form-control" name="txtYear" pattern="[0-9]{4}" title="Enter the year as (YYYY)" placeholder="Año" required="required" data-error="Valid birthday is required.">

                    <input class="wt" id="txtMonth" type="tel" class="form-control" name="txtMonth" pattern="[0-9]{2}" title="Enter the month as (MM)" placeholder="Mes" required="required" data-error="Valid birthday is required.">
                    ...
                    <div class="btn-group-horizontal btn-group-toggle" data-toggle="buttons">
                        ...
                        <div class="btn-group mr-2" role="group" aria-label="Second group">
                            <label class="btn btn-gender rounded mt-1">
                                <input type="radio" name="00N1Y00000Iqm89" id="00N1Y00000Iqm89_1" value="0" required>Femenino
                            </label>
                        </div>

                        <div class="btn-group mr-2" role="group" aria-label="Second group">
                            <label class="btn btn-gender rounded mt-1">
                                <input type="radio" name="00N1Y00000Iqm89" id="00N1Y00000Iqm89_2" value="1" required>Masculino
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <input style="color: #fff; font-family: avenir-regular; font-weight: 500;  font-size: 20px;" type="submit" id="submit2" name="clm_submit2_es" class="btn btn-success btn-send" value="Siguiente" onclick="passVarToAffiliates();">
