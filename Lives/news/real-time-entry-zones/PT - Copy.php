        ...
        <form method="POST" oninput="txtFullDate.value = txtYear.value +'-'+ txtMonth.value +'-'+ txtDay.value" _lpchecked="1">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <input style="color: #fff; font-family: avenir-regular; font-weight: 500;  font-size: 20px;" type="submit" id="submit2" name="clm_submit2" class="btn btn-success btn-send" value="Seguinte" onclick="passVarToAffiliates();">
