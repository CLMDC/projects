...
<div class="formStyle">
    <div class="ht">
        ...
        <form method="POST" oninput="txtFullDate.value = txtYear.value +'-'+ txtMonth.value +'-'+ txtDay.value" _lpchecked="1" id="myform">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <input oninput="this.value=this.value.toLowerCase()" id="UserName" type="email" name="UserName" class="form-control" placeholder="E-mail*" required="required" data-error="Valid email is required." value="<?php if ( isset( $email ) )
						echo $emailError ?>">
            ...
            <div class="col-md-7" style="padding-right: 5px;">
                <div class="form-group">
                    ...
                    <input class="wt" id="txtYear" type="tel" class="form-control" name="txtYear" pattern="[0-9]{4}" title="Enter the year as (YYYY)" placeholder="Ano" required="required" data-error="Valid birthday is required.">

                    <input class="wt" id="txtMonth" type="tel" class="form-control" name="txtMonth" pattern="[0-9]{2}" title="Enter the month as (MM)" placeholder="Mês" required="required" data-error="Valid birthday is required.">
                    ...
                    <div class="btn-group-horizontal btn-group-toggle" data-toggle="buttons">
                        ...
                        <div class="btn-group mr-2" role="group" aria-label="Second group">
                            <label class="btn btn-gender rounded mt-1">
                                <input type="radio" name="00N1Y00000Iqm89" id="00N1Y00000Iqm89_1" value="0" required>Feminino
                            </label>
                        </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <input style="color: #fff; font-family: avenir-regular; font-weight: 500;  font-size: 20px;" type="submit" id="submit2" name="clm_submit2_pt" class="btn btn-success btn-send" value="Seguinte" onclick="passVarToAffiliates();">
