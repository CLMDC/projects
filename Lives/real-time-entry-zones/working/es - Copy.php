...
input.wt[type=tel] {
  ...
  font-size: 14px;
                          ...
                          <div class="col-md-7" style="padding-right: 5px;">
                                <div class="form-group">
                                    <label for="phone">Fecha de nacimiento*</label><br/>                                                                       
                                    <input class="wt" id="" type="tel" class="form-control" name="txtYear" pattern="[0-9]{4}" title="Enter the year as (YYYY)" placeholder="Año" required="required" data-error="Valid birthday is required.">

                                    <input class="wt" id="" type="tel" class="form-control" name="txtMonth" pattern="[0-9]{2}" title="Enter the month as (MM)" placeholder="Mes" required="required" data-error="Valid birthday is required.">

                                    <input class="wt" type="tel" name="txtDay" pattern="[0-9]{2}" title="Enter the day as (DD)" placeholder="Día" required="required" data-error="Valid birthday is required.">
