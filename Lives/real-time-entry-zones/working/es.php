...
$data = array(
    ...
    'account-language-id' => 50,  // 1 -> English | 43 -> Portuguese | 50 -> Spanish
    'account-code-id' => 2,  
    'account-emir-id' => 1,
...
try {
   ...
   $mail->isHTML(true);
   $mail->setFrom('accounts@clmforex.com', 'Live Application Form - ES');
   $mail->addAddress('accounts@clmforex.com', 'CLM');

   //$mail->setFrom('danycan31416@gmail.com', 'Live Application Form - ES');
  ...
  $signature = $First_name." ".$Last_name." ".$Application_Date; 
   ...
   $pdf->Ln();
       ...
       if ($mail->addReplyTo($Email_reply, $First_name)) {
        ...
        $mail->Subject = 'Live Application Form - ES'; 
    ...
    $mail->addStringAttachment($pdfdoc, 'contact-es.pdf');
...
/* ------------------- Ends send email in PDF ------------------- */
        ...
        //$yourURL="/es/ingresa-cuenta-real-aplicacion/"; 
        $yourURL="/es/verifica-tu-cuenta-r/"; 
      ...
      //echo "Email duplicated";
        ...
        $emailError = 'Esta dirección de correo electrónico ya está registrada';  
    }
...
/* form { margin:50px auto;max-width:560px;}    */
    ...
    <style type="text/css">
        @font-face {
          ...
          src: url(/es/wp-content/uploads/2019/04/AvenirNextLTPro-Regular-1.woff);
...
<!--         <script>       
        ...
        function formatOptions (state) {
            if (!state.id) {
             ...
             var baseUrl = "https://clmmultisites.wpengine.com/es/wp-content/uploads/2019/06/";
...
<script type="text/javascript">
            (async() => {
              //const res = await fetch("https://free.ipwhois.io/json/");
              const res = await fetch("https://ipapi.co/json/");
              const json = await res.json();
...
<!-- <center><h1 style="color:#fff">Create your account</h1></center> -->
    <div class="formStyle">
      <div class="ht">
      <!-- form method="POST" oninput="txtFullDate.value = txtYear.value +'-'+ txtMonth.value +'-'+ txtDay.value"  _lpchecked="1" action="#"> -->
      <form method="POST">
        <!-- <input id="redirect_url" type="hidden" name="redirect_url" value="https://www.clmforex.com/demo-account-thank-you"; /> -->
                            ...
                            <div class="col-md-5" style="padding-right: 5px; padding-left: 10px;">   
                                <div class="form-group">
                                    <input onkeyup="javascript:capitalize(this);" id="individual-first-name" type="text" name="individual-first-name" class="form-control" placeholder="Nombre*" required="required" data-error="Nombre es requiredo.">
                            ...
                            <div class="col-md-5" style="padding-left: 5px;">
                                <div class="form-group">
                                    <input onkeyup="javascript:capitalize(this);" id="individual-last-name" type="text" name="individual-last-name" class="form-control" placeholder="Apellido*" required="required" data-error="Apellido es requiredo.">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>

                            <!-- Hidden -->
                            <input id="Preferred_Language__c" type="hidden" name="Preferred_Language__c" class="form-control" placeholder="Por favor ingrese su teléfono*" required="required" data-error="Phone is required." value="Spanish">

                            <input id="lead_source" type="hidden" name="lead_source" class="form-control" placeholder="Please enter your phone number *" required="required" data-error="Phone is required." value="Live Account (Real-Time Entry Zones)">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input oninput="this.value=this.value.toLowerCase()" id="UserName" type="email" name="UserName" class="form-control" placeholder="Correo electrónico*" required="required" data-error="Un email válido es requerido." value="<?php if (isset($email)) echo $emailError ?>">
...
<script type="text/javascript">
   ...
   {
        document.getElementById('txtFullDate').value = 
        ...
        document.getElementById('txtDay').value;
                          ...
                          <div class="col-md-7" style="padding-right: 5px;">
                                <div class="form-group">
                                    ...
                                    <input class="wt" id="txtYear" type="tel" class="form-control" name="txtYear" pattern="[0-9]{4}" title="Enter the year as (YYYY)" placeholder="Año" required="required" data-error="Valid birthday is required." oninput="generateFullName()">

                                    <input class="wt" id="txtMonth" max="12" type="number" class="form-control" name="txtMonth" pattern="[0-9]{2}" title="Enter the month as (MM)" placeholder="Mes" required="required" data-error="Valid birthday is required." oninput="generateFullName()">

                                    <input class="wt" id="txtDay" max="31" type="number" name="txtDay" pattern="[0-9]{2}" title="Enter the day as (DD)" placeholder="Día" required="required" data-error="Valid birthday is required." oninput="generateFullName()">
                                        ...
                                        <div class="btn-group-horizontal btn-group-toggle" data-toggle="buttons">
                                          ...
                                          <div class="btn-group mr-2" role="group" aria-label="Second group">            
                                              <label class="btn btn-gender rounded mt-1">
                                                <input type="radio" name="00N1Y00000Iqm89" id="" value="0" required>Femenino                   
                                              </label>
                                          </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <!-- <input id="phone" type="tel" pattern=".{8,}" title="Put at least 8 characters" name="phone" class="form-control" placeholder="Por favor ingresa tu número telefónico *" required="required" data-error="Valid phone is required.">
 -->
                                    <input id="phone" type="tel" pattern="[0-9]{8,}" title="Debe contener solo números, y al menos 8 o más números" name="phone" class="form-control" placeholder="Please enter your phone *" required="required" data-error="Valid phone is required.">
                                </div>
                            </div>
                              ...
                              <div class="form-group">
                                  <label >WhatsApp*</label><br/>
                                        <div class="btn-group-horizontal btn-group-toggle" data-toggle="buttons">
                                          ...
                                          <div class="btn-group mr-2" role="group" aria-label="Second group">            
                                              <label class="btn btn-gender rounded mt-1">
                                                <input type="radio" name="whatsapp" id="" value="Yes" required>Si   
                                              </label>
                                          </div>
                            ...
                            <div class="col-md-6">  
                            <label for="first_name" class="font-safari" style="color: #b1b1b1 !important; font-weight: 600 !important; width: 100% !important; font-size: 13px !important;">¿Cuáles  productos operas?*</label>
                            <select class="js-example-basic-multiple" id="Trading_Product__c" name="Trading_Product__c[]" multiple="multiple" required>
                                ...
                                <option value="Binary Options">Opciones</option>     
                            </select>
                          </div> 
...
<div class="col-md-7">
  <div class="form-group">
  <label for="first_name">Moneda base*</label><br/>
            <div class="btn-group-horizontal btn-group-toggle" data-toggle="buttons">
              ...
              <!-- </div> -->
                            ...
                            <div class="col-md-5">
                              <div class="form-group">
                                  <label for="first_names">Tipo de cuenta*</label><br/>
                                        <div class="btn-group-horizontal btn-group-toggle" data-toggle="buttons">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="first_name">¿Cómo te enteraste de nosotros?</label>
                                    <input id="who_referred_you" type="text" name="who_referred_you" class="form-control" placeholder="Escribe tu respuesta"data-error="Firstname is required.">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="x" style="position:relative; padding-left:27px; display:block; color: #515151 !important; display: block; font-size: 11px; font-family: avenir-regular !important; font-weight: 500 !important;"><input class="abc" type="checkbox" required="required"><span class="tyc" id="tc" style="display: flex; text-align: justify !important;">Al continuar y enviar esta aplicación, reconozco que estoy firmando de forma electrónica sus <a href="https://clmforex.com/wp-content/uploads/legal-documents/CLMarkets-Terms-Conditions.pdf" target="_blank">Términos y Condiciones</a> y cualquier <a href="/es/legal-documents/" target="_blank">documento legal</a> relacionado, y que este es un acuerdo contractual que me vincula legalmente.  Confirmo que entiendo plenamente la naturaleza y los riesgos que conlleva operar forex, CFDs y sus productos derivados. Por este medio confirmo que estoy actuando por mi propia voluntad, y que no he sido influenciado por CLMarkets Ltd. o cualquier persona asociada con la compañía.</span></label>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>    
  ...
  #tc a{
    ...
    display: contents !important;
                            ...
                            <div class="col-md-12">
                                ...
                                <!-- Working good...
                                <input style="color: #fff; font-family: avenir-regular; font-weight: 500;  font-size: 20px;" type="submit" name="submit2" class="btn btn-success btn-send" value="Siguiente">     
                                -->
                                
                                <!-- Only add the vars to auto populate -->  
                                <input style="color: #fff; font-family: avenir-regular; font-weight: 500;  font-size: 20px;" type="submit" name="submit2" class="btn btn-success btn-send" value="Siguiente" onclick="passVarToAffiliates();">
