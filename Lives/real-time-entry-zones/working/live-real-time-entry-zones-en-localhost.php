...
//create array of data to be postedsubmit2
$post_data['oid'] = $oid;
...
$post_data['Date_Live_Account__c'] = trim($_POST['Date_Live_Account__c']);
...
$TitleB = $_POST['individual-title-id'];
  ...
  if( $TitleB == '1' ) $Title = 'Mr.';
  if( $TitleB == '2' ) $Title = 'Mrs.';
  if( $TitleB == '3' ) $Title = 'Miss';
  if( $TitleB == '4' ) $Title = 'Ms.';
...
//$GenderB = $_POST['00N1Y00000Iqm89'];
  ...
  if( $GenderB == '0' ) $Gender = 'Female';
  if( $GenderB == '1' ) $Gender = 'Male';
$Gender = $Gender;
...
try {
   ...
   $mail->isHTML(true);
   //$mail->setFrom('accounts@clmforex.com', 'Live Application Form');
   //$mail->addAddress('accounts@clmforex.com', 'CLM');

   $mail->setFrom('danycan31416@gmail.com', 'Live Application Form');
  ...
  $signature = $First_name." ".$Last_name." ".$Application_Date; 
   ...
   $pdf->Ln();
       ...
       if ($mail->addReplyTo($Email_reply, $First_name)) {
        ...
        $mail->Subject = 'Live Application Form'; 
...
////////////////////////////////Test code
        ...
        //$yourURL="https://login.clmforex.com/";
        //$yourURL="/sign-in-live-account/";
        $yourURL="/video-r.php";
        //https://clmforex.com/sign-in-2/
        //<form action="https://login.clmforex.com/" method="post" novalidate="novalidate" _lpchecked="1"> 
  ...
  #pageloader img
  {
    ...
    position: fixed;
        ...
        <!-- <input id="redirect_url" type="hidden" name="redirect_url" value="https://www.clmforex.com/demo-account-thank-you"; /> -->
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input oninput="this.value=this.value.toLowerCase()" id="UserName" type="email" name="UserName" class="form-control" placeholder="Email address*" required="required" data-error="Valid email is required." value="<?php if (isset($email)) echo $emailError ?>">
        ...
        document.getElementById('txtDay').value;
                          ...
                          <div class="col-md-7" style="padding-right: 5px;">
                                <div class="form-group">
                                    ...
                                    <input class="wt" id="txtYear" type="tel" class="form-control" name="txtYear" pattern="[0-9]{4}" title="Enter the year as (YYYY)" placeholder="Year" required="required" data-error="Valid birthday is required." oninput="generateFullName()">

                                    <input class="wt" id="txtMonth" max="12" type="number" class="form-control" name="txtMonth" pattern="[0-9]{2}" title="Enter the month as (MM)" placeholder="Month" required="required" data-error="Valid birthday is required." oninput="generateFullName()">

                                    <input class="wt" id="txtDay" max="31" type="number" name="txtDay" pattern="[0-9]{2}" title="Enter the day as (DD)" placeholder="Day" required="required" data-error="Valid birthday is required." oninput="generateFullName()">

                                     
                                    
                                    <input type="text" id="txtFullDate" name="txtFullDate"  >
...
<!--  <script type="text/javascript">
   ...
   {
        document.getElementById('txtFullDate').value = 
        document.getElementById('txtYearC').value + '-' + 
        document.getElementById('txtDayC').value + '-' +
        document.getElementById('txtMonthC').value;

   }
</script>
<br/><br/><br/>

YEAR <input type="text" id="txtYearC"  /><br/>
MONTH <input type="text" id="txtDayC"  /><br/>
DAY <input type="text" id="txtMonthC" oninput="generateFullName()" /><br/>
Full name  <input type="text" id="txtFullDate" name="txtFullDate"  > <br><br> -->
                                        ...
                                        <div class="btn-group-horizontal btn-group-toggle" data-toggle="buttons">
                                          ...
                                          <div class="btn-group mr-2" role="group" aria-label="Second group">            
                                              <label class="btn btn-gender rounded mt-1">
                                                <input type="radio" name="00N1Y00000Iqm89" id="" value="0" required>Female                  
                                              </label>
                                          </div>

                                          <div class="btn-group mr-2" role="group" aria-label="Second group">
                                              <label class="btn btn-gender rounded mt-1">
                                                <input type="radio" name="00N1Y00000Iqm89" id="" value="1" required>Male
                                              </label>
                                          </div>
                                        </div>
                                </div>
