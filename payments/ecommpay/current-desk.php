...
// Whithout is_test
$s = hash_hmac('sha512', "close_on_missclick:1=true;customer_first_name:Dany;customer_last_name:Can;customer_phone:0000-0000;force_payment_method:card;language_code:ru;payment_amount:1990000;payment_currency:USD;payment_description:10002;payment_id:106205;project_id:2089;region_code:US", "af51d7c1231907e445362aab60be2d176315e0cff07a5c17d8416fbac87aa8db68f740404403255dfc88c3aba88bfc43c5362f23f6b27faed1adfd65e72c8a7a", true);
...
// Without is_test
header("Location: https://cashier.paywallk.com/payment?"."signature=".$sign."&payment_id=".$payment_id."&payment_amount=".$payment_amount."&payment_currency=".$payment_currency."&project_id=".$project_id."&payment_description=".$payment_description."&region_code=".$region_code."&language_code=".$language_code."&force_payment_method=".$force_payment_method."&customer_phone=".$customer_phone."&customer_last_name=".$customer_last_name."&customer_first_name=".$customer_first_name."&close_on_missclick=".$close_on_missclick);
exit;
