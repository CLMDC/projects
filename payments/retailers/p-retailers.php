...
if ($country == 'BR' || $country == 'CL'){
    $data = array(
                ...
                "returnUrl" => 'https://payment-form.payretailers.com',
                "cancelUrl" => 'https://payment-form.payretailers.com',                               
                "language" => $country,
                    "customer"=> array (
                        ...
                        "email"=> $email_address,
                        "country"=> $country,
                        "city"=> $citizenship_country,
                        "zip"=> $residence_country_postal,
                        "address"=> $citizenship_country,
                        //"phone"=> $mobile_number,
                        "phone"=> '',
                        "deviceId"=> null,
                        "ip"=> $ip
...
$ch = curl_init(); 
curl_setopt($ch, CURLOPT_URL, "https://api.gateway.payretailers.com/v2/paywalls");    
...
echo $data['uid'];echo '<br/>';
echo $data['trackingId'];echo '<br/>';
echo $data['amount'];echo '<br/>';
echo $data['currency'];echo '<br/>';
echo $data['description'];echo '<br/>';
echo $data['createdAt'];echo '<br/>';
echo $data['cancelUrl'];echo '<br/>';
echo $data['returnUrl'];echo '<br/>';
echo $data['notificationUrl'];echo '<br/>';

// Customer's array
echo $data['customer']['firstName'];echo '<br/>';
echo $data['customer']['lastName'];echo '<br/>';
echo $data['customer']['personalId'];echo '<br/>';
echo $data['customer']['email'];echo '<br/>';
echo $data['customer']['country'];echo '<br/>';
echo $data['customer']['city'];echo '<br/>';
echo $data['customer']['zip'];echo '<br/>';
echo $data['customer']['address'];echo '<br/>';
echo $data['customer']['phone'];echo '<br/>';
echo $data['customer']['deviceId'];echo '<br/>';
echo $data['customer']['ip'];echo '<br/>';
echo $data['customer']['accountType'];echo '<br/>';

// Form's array URL
echo $data['form']['action'];echo '<br/>';
...
// PayRetailers direction
header("Location: https://payretailers-api.azurewebsites.net/v2/public/paywalls/landing/".$Url);
exit;
...
/*
Ecommpay                                    ->                  CD                              Pay Retailers

payment_id: 247736                                              transaction_id                  trackingId
payment_amount: 10000                                           amount                          amount
payment_currency: USD                                           currency                        currency
payment_description: Nothig to put                              account_id                      description
customer_phone: 7499123456s7                                    mobile_number                   phone
customer_last_name: Can                                         last_name                       lastName                                
customer_first_name: Dany                                       first_name                      firstName
                                                                email_address                   email
                                                                residence_country               country
                                                                citizenship_country             country
                                                                residence_country_postal        zip
*/
...
pg_phone parameter is required and must be a valid phone number



http://localhost/payments/retailers/p-retailers.php?account_id=20830%first_name=Maya%last_name=Solombrino%20-%20Test%email_address=accounting@clmforex.com%residence_country=Brazil%citizenship_country=Guatemala%residence_country_postal=-----%mobile_number=34637732704%amount=20.5700%currency=USD%funding_source_id=137%transaction_id=121184%funding_source_name=Credit%20Card%20%organization_id=144

http://localhost/payments/retailers/p-retailers.php?account_id=20830%first_name=Maya%last_name=Solombrino%20-%20Test%email_address=accounting@clmforex.com%residence_country=Chile%citizenship_country=Guatemala%residence_country_postal=-----%mobile_number=34637732704%amount=20.5700%currency=USD%funding_source_id=137%transaction_id=121184%funding_source_name=Credit%20Card%20%organization_id=144

http://localhost/payments/retailers/p-retailers.php?account_id=20830%first_name=Maya%last_name=Solombrino%20-%20Test%email_address=accounting@clmforex.com%residence_country=Colombia%citizenship_country=Guatemala%residence_country_postal=-----%mobile_number=34637732704%amount=20.5700%currency=USD%funding_source_id=137%transaction_id=121184%funding_source_name=Credit%20Card%20%organization_id=144

http://localhost/payments/retailers/p-retailers.php?account_id=20830%first_name=Maya%last_name=Solombrino%20-%20Test%email_address=accounting@clmforex.com%residence_country=Mexico%citizenship_country=Guatemala%residence_country_postal=-----%mobile_number=34637732704%amount=20.5700%currency=USD%funding_source_id=137%transaction_id=121184%funding_source_name=Credit%20Card%20%organization_id=144
